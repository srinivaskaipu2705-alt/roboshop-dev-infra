...
#   description = "security group for catalogue with custom ports open with VPC, eggress all traffic"
...
module "sg" {
    ...
    source = "git::https://github.com/srinivaskaipu2705-alt/terraform-aws-sg.git?ref=main"
